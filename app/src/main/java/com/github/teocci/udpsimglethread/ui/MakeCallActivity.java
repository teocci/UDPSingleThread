...
{
    public static final String TAG = LogHelper.makeLogTag(MakeCallActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        displayName = intent.getStringExtra(Config.EXTRA_DISPLAY_NAME);
        contactName = intent.getStringExtra(Config.EXTRA_CONTACT_NAME);
        contactIp = intent.getStringExtra(Config.EXTRA_IP);
